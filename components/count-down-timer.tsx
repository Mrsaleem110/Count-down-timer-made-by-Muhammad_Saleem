...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-red-900">
      {/* Timer box container */}
      <div className="bg-red dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md">
